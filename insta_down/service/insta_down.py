...
def download_post(request):
    ...
    # short_code = 'B_UpPnVDEPW' # This line test no image in the post.
    # short_code = 'B_NV7Nujzd8'
    short_code = 'B_XgIPYjmYd'
...
def download_album(request):
    ...
    id = response['graphql']['user']['id'] # This line is temporary.
    owner = dict(
        id=id,
